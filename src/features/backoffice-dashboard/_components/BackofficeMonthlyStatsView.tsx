...
import { useAdminMonthlyAgentCards } from "@/features/admin-dashboard/_lib/hooks";
...
export function BackofficeMonthlyStatsView({
  ...
  const chartAgents: Agent[] = cards.map((card, index) => ({
    recordId: card.id,
    name: card.name,
    ...
    today_calls_made: 0,
    winner: false,
    monthly_calls: card.monthlyPoints,
    monthly_hot_leads: 0,
  ...
  return (
    <>
      ...
      <div className="space-y-6">
        ...
        <AgentScoreCards cards={cards} isLoading={isLoading} />
